    ...
    public class PoisonEnchantSystem : IExecuteSystem
    {
        ...
        public void Execute()
        {
            ...
            foreach (GameEntity armament in _armaments.GetEntities(_buffer))
            {
                ...
                {
                    GetOrAddStatusSetup(armament).AddRange(_staticDataService.GetEnchantConfig(EnchantTypeId.PoisonArmaments).StatusSetups);
        ...
        private static List<StatusSetup> GetOrAddStatusSetup(GameEntity armament)
        {

...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithApplierStatusLink(this GameContext context, float Value) {
        return ((Entitas.EntityIndex<GameEntity, float>)context.GetEntityIndex(Contexts.ApplierStatusLink)).GetEntities(Value);
    }

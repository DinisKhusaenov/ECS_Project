...
namespace Code.Meta.UI.Shop.Systems
{
    public class BuyItemOnRequestSystem : IExecuteSystem
    {
        ...
        private readonly IGroup<MetaEntity> _shopItemPurchaseRequest;
        ...
        public BuyItemOnRequestSystem(MetaContext meta, IShopUIService shopUIService)
        {
            ...
            _shopItemPurchaseRequest = meta.GetGroup(MetaMatcher
                .AllOf(
        ...
        public void Execute()
        {
            ...
            foreach (MetaEntity request in _shopItemPurchaseRequest)
            {
